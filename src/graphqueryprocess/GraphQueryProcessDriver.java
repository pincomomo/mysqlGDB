 ...
 * @author LCJ
 */
public class GraphQueryProcessDriver {
    ...
    public static void main(String[] args) throws InstantiationException, SQLException {
        ...
        */
        ...
        //ResultSet restemp = process.Process(connection, "SELECT egid FROM edges WHERE efrom = 1");
        restemp.next();
        System.out.println(restemp.getInt("egid"));
